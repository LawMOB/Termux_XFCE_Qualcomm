...
wget https://github.com/LawMOB/Termux_XFCE_Qualcomm/raw/main/mesa-vulkan-kgsl_24.1.0-ubuntu_arm64.deb
mv mesa-vulkan-kgsl_24.1.0-ubuntu_arm64.deb $HOME/../usr/var/lib/proot-distro/installed-rootfs/debian/root/
proot-distro login debian --shared-tmp -- env DISPLAY=:1.0 dpkg -i mesa-vulkan-kgsl_24.1.0-ubuntu_arm64.deb
proot-distro login debian --shared-tmp -- env DISPLAY=:1.0 rm mesa-vulkan-kgsl_24.1.0-ubuntu_arm64.deb
